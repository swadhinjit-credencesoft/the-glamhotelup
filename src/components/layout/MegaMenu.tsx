                    ...
                    >
                      ...
                      <div className="relative z-20 h-full flex flex-col justify-end text-white pb-6 px-4">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <Link href="https://bookone.io/The-Glam?bookingEngine=true" className="text-adani-orange font-bold text-sm uppercase tracking-wide hover:text-white transition-colors">
                            Book Now
                          </Link>
                        </div>
                      </div>
