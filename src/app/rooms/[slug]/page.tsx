...
const ROOM_META: Record<string, { name: string; title: string | { absolute: string }; description: string; image: string }> = {
  "deluxe-room": {
    name: "Deluxe Room",
    title: { absolute: "Deluxe Room in Greater Noida | The Glam by Sandane Homes" },
    description:
  ...
  "suite-room": {
    name: "Suite Room",
    title: { absolute: "Suite Room in Greater Noida | The Glam by Sandane Homes" },
    description:
  ...
  "luxury-room": {
    name: "Luxury Room",
    title: { absolute: "Luxury Room in Greater Noida | The Glam by Sandane Homes" },
    description:
