...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    ctaLink: "https://bookone.io/The-Glam?bookingEngine=true",
  },
  {
    id: 2,
...
export const JOIN_US_CARDS = [
  ...
  { id: 4, label: "Book Your Stay", link: "https://bookone.io/The-Glam?bookingEngine=true", img: "/images/welcome.avif", fallback: "bg-adani-dark" },
];
